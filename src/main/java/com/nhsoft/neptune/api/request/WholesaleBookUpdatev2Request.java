...
/**
 * wholesaleBookUpdateV2请求类
 * 批发订单修改
 */
public class WholesaleBookUpdatev2Request implements ApiCloudRequest<WholesaleBookUpdateDTOModel, WholesaleBookVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.book.update/v2";
    }
