 ...
 * 超量特价审核
 */
public class PolicyQuantityAuditRequest implements ApiCloudRequest<PolicyQuantityUpdateDTOModel, PolicyQuantityVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.policy.quantity.audit";
    }
