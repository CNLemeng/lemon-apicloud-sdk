...
/**
 * wholesaleBookSaveAndAuditV2请求类
 * 批发订单新增并审核
 */
public class WholesaleBookSaveandauditv2Request implements ApiCloudRequest<WholesaleBookSaveDTOModel, WholesaleBookVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.book.saveandaudit/v2";
    }
