...
/**
 * wholesaleBookAuditV2请求类
 * 批发订单审核
 */
public class WholesaleBookAuditv2Request implements ApiCloudRequest<WholesaleBookUpdateDTOModel, WholesaleBookVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.book.audit/v2";
    }
