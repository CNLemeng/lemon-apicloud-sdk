...
/**
 * wholesaleOrderSaveV2请求类
 * 批发销售单新增
 */
public class WholesaleOrderSavev2Request implements ApiCloudRequest<WholesaleOrderSaveDTOModel, WholesaleOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.order.save/v2";
    }
