 ...
 * 供应商付款单反审核
 */
public class SettlementSupplierpaymentUnauditRequest implements ApiCloudRequest<SupplierPaymentAuditDTOModel, SupplierPaymentResponseDTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.settlement.supplierpayment.unaudit";
    }
