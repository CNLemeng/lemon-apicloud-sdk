...
/**
 * wholesaleOrderSaveAndAuditV2请求类
 * 批发销售单新增并审核
 */
public class WholesaleOrderSaveandauditv2Request implements ApiCloudRequest<WholesaleOrderSaveDTOModel, WholesaleOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.order.saveandaudit/v2";
    }
