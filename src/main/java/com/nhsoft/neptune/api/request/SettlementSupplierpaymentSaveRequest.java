...
/**
 * saveSupplierPaymentSettlement请求类
 * 供应商付款单新增
 */
public class SettlementSupplierpaymentSaveRequest implements ApiCloudRequest<SupplierPaymentSaveDTOModel, SupplierPaymentResponseDTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.settlement.supplierpayment.save";
    }
