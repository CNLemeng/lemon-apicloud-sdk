 ...
 * 售后申请单新增
 */
public class WholesaleInnerorderSavev2Request implements ApiCloudRequest<WholesaleInnerOrderSaveDTOModel, WholesaleInnerOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.innerorder.save/v2";
    }
