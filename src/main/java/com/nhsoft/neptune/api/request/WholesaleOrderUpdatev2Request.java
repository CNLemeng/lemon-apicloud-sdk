...
/**
 * wholesaleOrderUpdateV2请求类
 * 批发销售单修改
 */
public class WholesaleOrderUpdatev2Request implements ApiCloudRequest<WholesaleOrderUpdateDTOModel, WholesaleOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.order.update/v2";
    }
