...
/**
 * wholesaleReturnUpdateV2请求类
 * 批发退货单修改
 */
public class WholesaleReturnUpdatev2Request implements ApiCloudRequest<WholesaleReturnUpdateDTOModel, WholesaleReturnVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.return.update/v2";
    }
