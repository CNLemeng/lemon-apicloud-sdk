 ...
 * 售后申请单审核
 */
public class WholesaleInnerorderAuditv2Request implements ApiCloudRequest<WholesaleInnerOrderUpdateDTOModel, WholesaleInnerOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.innerorder.audit/v2";
    }
