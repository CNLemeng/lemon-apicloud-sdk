...
/**
 * ClientRequestTimeFoodFullyVO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ClientRequestTimeFoodFullyVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="商品范围(按商品|按类别|按部门|全部商品)", example="按类别")
    ...
    @ApiCloudField(value="应用范围(按客户|按客户等级)", example="按客户")
    ...
    @ApiCloudField(value="部门列表")
    private List<String> departmentNames;
    @ApiCloudField(value="商品类别列表")
