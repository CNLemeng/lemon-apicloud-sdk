...
public class PosItemSaveV2DTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="商品类型编号(1:标准4:组合商品5:非库存商品6:制单组合7:制单拆分8:自定义组合9:成分商品10:分级商品11:原料商品)", example="1", required=true)
    ...
    @ApiCloudField(value="商品类别代码", example="001", required=true)
    ...
    @ApiCloudField(value="商品销售单价（小数点2位）", example="10.0", required=true)
    ...
    @ApiCloudField(value="商品批发价（小数点4位）", example="10.0", required=true)
    ...
    @ApiCloudField(value="item_del_tag")
    ...
    @ApiCloudField(value="management_template_names")
    private List<String> managementTemplateNames;
    @ApiCloudField(value="request_template_names")
    private List<String> requestTemplateNames;
