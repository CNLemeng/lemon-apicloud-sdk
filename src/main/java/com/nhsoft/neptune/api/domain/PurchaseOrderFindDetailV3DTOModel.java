...
/**
 * PurchaseOrderFindDetailV3DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PurchaseOrderFindDetailV3DTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="供应商送货 发货数量（小数点3位）", example="1.0")
    private BigDecimal detailSendUseQty;
    @ApiCloudField(value="生产日期", example="2021-01-01")
    private String detailProducingDate;
    @ApiCloudField(value="已收货数量", example="10.0")
    private BigDecimal itemReceivedQty;
    @ApiCloudField(value="已收货赠品数量", example="10.0")
    private BigDecimal itemReceivedPresentQty;
