...
public class CardSettlementVOModel extends ApiCloudObject {
    ...
    private List<CardDepositVOModel> cardDepositDetails;
    @ApiCloudField(value="消费明细", example="")
    private List<CardConsumeVOModel> cardConsumeDetails;
    @ApiCloudField(value="补扣明细", example="")
    private List<CardConsumeVOModel> recardDetails;
