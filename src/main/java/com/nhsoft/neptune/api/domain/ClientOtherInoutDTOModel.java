...
/**
 * ClientOtherInoutDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ClientOtherInoutDTOModel extends ApiCloudObject {

    @ApiCloudField(value="费用单号", example="OP2072010000016")
    private String otherInoutFid;
    @ApiCloudField(value="中心门店编码", example="99")
    ...
    @ApiCloudField(value=" 格式：yyyy-MM-dd HH:mm:ss", example="2021-01-27 00:00:00")
