...
public class PosItemGradeSaveV2DTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="速记码", example="YJ", required=true)
    private String itemGradePinyin;
    @ApiCloudField(value="分级类型( 1:精品 2:一级 3:二级 4:三级 5:残次)", example="1", required=true)
    ...
    @ApiCloudField(value="标准售价（小数点2位）", example="10.0", required=true)
    private BigDecimal itemGradeRegularPrice;
    @ApiCloudField(value="售价2（小数点2位）", example="11.0", required=true)
    private BigDecimal itemGradeLevel2Price;
    @ApiCloudField(value="售价3（小数点2位）", example="12.0", required=true)
    private BigDecimal itemGradeLevel3Price;
    @ApiCloudField(value="售价4（小数点2位）", example="13.0", required=true)
    ...
    @ApiCloudField(value="允许前台折扣", example="1", required=true)
    private Integer itemGradeDiscounted;
    @ApiCloudField(value="允许前台议价", example="2", required=true)
