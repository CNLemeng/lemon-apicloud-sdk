...
/**
 * PolicyPromotionUpdateDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PolicyPromotionUpdateDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="促销单号", example="4344990002089", required=true)
