...
/**
 * WholesaleBookSaveDTO模型
 * 批发订单保存参数
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class WholesaleBookSaveDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="wholesale_book_split_flag")
    private Boolean wholesaleBookSplitFlag;
    ...
    @ApiCloudField(value="访销、车销、档口、内勤", example="访销")
    private String wholesaleBookType;
    @ApiCloudField(value="wholesale_book_type_id")
    private String wholesaleBookTypeId;
}
