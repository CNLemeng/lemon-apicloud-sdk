...
/**
 * ProcessingInOrderUpdateV2DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ProcessingInOrderUpdateV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="加工入库编号", example="JI4344991001448", required=true)
