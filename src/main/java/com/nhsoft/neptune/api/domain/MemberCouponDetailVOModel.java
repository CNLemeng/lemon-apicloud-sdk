...
public class MemberCouponDetailVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="券id", example="", required=true)
    private String id;
    @ApiCloudField(value="活动明细ID", required=true)
    private Long activityDetailId;
    @ApiCloudField(value="可用结束时间", example="")
    private String availEnd;
    @ApiCloudField(value="可用开始时间", example="", required=true)
    private String availStart;
    @ApiCloudField(value="创建时间", example="")
    private String createAt;
    @ApiCloudField(value="更新时间", example="", required=true)
    ...
    private String memo;
    @ApiCloudField(value="券状态(CREATED)", example="")
