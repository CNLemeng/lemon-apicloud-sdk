...
public class PlatformCouponBillFindDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="平台核销门店Id(如抖音门店编号)")
    private String platformConsumeBranchId;
    @ApiCloudField(value="券编号")
    private String identityCode;
    @ApiCloudField(value="账单日期YYYY-MM-DD", example="2025-05-01")
    private String billDate;
    @ApiCloudField(value="券类型列表")
    private List<Long> couponTypeIds;
    @ApiCloudField(value="线下核销门店列表")
