...
public class PosOrderVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="成本金额", example="20.0")
    private BigDecimal orderCostMoney;
    @ApiCloudField(value="原价合计（原价合计=单据总额+订单折扣）", example="10.0")
    private BigDecimal orderPriceMoney;
    @ApiCloudField(value="单据总额（小数点2位）", example="10.0")
    private BigDecimal orderTotalMoney;
    @ApiCloudField(value="实收金额(实际应收+消费券金额-经理折扣)", example="10.0")
    private BigDecimal orderReceiveMoney;
    ...
    @ApiCloudField(value="买家实付", example="1.0")
    private BigDecimal orderBuyerReceive;
    ...
    @ApiCloudField(value="券售价分摊")
    private BigDecimal totalCouponSaleShareDiscount;
    @ApiCloudField(value="销售渠道(线下|线上-微商城|线上-订单聚合)", example="线下")
    private String orderSaleChannel;
    @ApiCloudField(value="销售类型", example="销售")
