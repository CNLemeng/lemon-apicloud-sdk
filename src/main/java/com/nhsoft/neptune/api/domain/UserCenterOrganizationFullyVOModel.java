...
/**
 * UserCenterOrganizationFullyVO模型
 * 组织详情
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class UserCenterOrganizationFullyVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="parent_organization")
    private UserCenterOrganizationSimpleVOModel parentOrganization;
    @ApiCloudField(value="下级组织数量", example="3")
    private Integer subOrganizationCount;
    @ApiCloudField(value="组织及下级组织总用户数量", example="20")
