...
/**
 * PolicyPresentUpdateDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PolicyPresentUpdateDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="赠品促销单据号", example="4344990000325", required=true)
