...
public class PriceAdjustmentVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="修改时间（yyyy-MM-dd HH:mm:ss）", example="2021-01-01")
    ...
    @ApiCloudField(value="生效时间（yyyy-MM-dd HH:mm:ss）", example="2021-01-01 00:00:00")
    private String priceAdjustmentEffectiveTime;
    ...
    @ApiCloudField(value="失效时间（yyyy-MM-dd HH:mm:ss）", example="2021-01-01 00:00:00")
    private String priceAdjustmentInvalidWholeTime;
