...
/**
 * SupplierSettlementAuditRequestDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class SupplierSettlementAuditRequestDTOModel extends ApiCloudObject {

    @ApiCloudField(value="供应商结算单号", example="CP4344990000237", required=true)
