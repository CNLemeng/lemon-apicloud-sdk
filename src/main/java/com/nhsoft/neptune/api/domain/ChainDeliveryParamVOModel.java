...
/**
 * ChainDeliveryParamVO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ChainDeliveryParamVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="transfer_out_use_once")
    private Boolean transferOutUseOnce;
    ...
    @ApiCloudField(value="out_order_split_amount")
    private Integer outOrderSplitAmount;
    ...
    @ApiCloudField(value="cal_day_param_one")
    private Integer calDayParamOne;
    @ApiCloudField(value="cal_day_param_two")
    private Integer calDayParamTwo;
    @ApiCloudField(value="out_amount_type")
    private Integer outAmountType;
    ...
    @ApiCloudField(value="sms_payment_chain_context")
    private String smsPaymentChainContext;
    @ApiCloudField(value="sms_affirm_chain_context")
    ...
    @ApiCloudField(value="request_auto_gener_out_order")
    private Boolean requestAutoGenerOutOrder;
    @ApiCloudField(value="request_not_show_center_invetory")
    private Boolean requestNotShowCenterInvetory;
    @ApiCloudField(value="cal_day_param_three")
    ...
    @ApiCloudField(value="属性为空或0取配送中心", example="false")
    private Boolean getCenterBranchDistributionMatrix;
    @ApiCloudField(value="门店非要货时段允许保存要货单", example="true")
    private Boolean allowRequest;
    @ApiCloudField(value="管理中心允许非要货时段保存审核要货单", example="true")
    private Boolean centerAllowRequest;
}
