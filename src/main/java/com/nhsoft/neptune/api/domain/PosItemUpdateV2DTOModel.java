...
/**
 * PosItemUpdateV2DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PosItemUpdateV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="商品编码")
    private Integer itemNum;
    @ApiCloudField(value="商品名称", example="好丽友注心蛋黄派")
    ...
    @ApiCloudField(value="商品代码", example="000000000004")
    ...
    @ApiCloudField(value="商品部门", example="市场百货")
    ...
    @ApiCloudField(value="商品售价3（小数点2位）", example="11.0")
    private BigDecimal itemLevel3Price;
    @ApiCloudField(value="商品售价4（小数点2位）", example="12.0")
    private BigDecimal itemLevel4Price;
    @ApiCloudField(value="商品批发价（小数点4位）", example="10.0")
    private BigDecimal itemWholesalePrice;
    @ApiCloudField(value="商品批发售价2（小数点2位）", example="11.0")
    private BigDecimal itemLevel2Wholesale;
    @ApiCloudField(value="商品批发售价3（小数点2位）", example="12.0")
    private BigDecimal itemLevel3Wholesale;
    @ApiCloudField(value="商品批发售价4（小数点2位）", example="13.0")
    ...
    @ApiCloudField(value="商品类别名称", example="市场百货")
    private String itemCategory;
    @ApiCloudField(value="休眠标记(0正常，1休眠)", example="1")
    private Integer itemStatus;
    @ApiCloudField(value="积分值", example="10.0")
    ...
    private PosItemCommissionSaveDTOModel posItemCommission;
