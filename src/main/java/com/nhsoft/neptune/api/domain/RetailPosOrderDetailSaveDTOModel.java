...
/**
 * RetailPosOrderDetailSaveDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RetailPosOrderDetailSaveDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="商品总金额（小数点2位）", example="1.0", required=true)
