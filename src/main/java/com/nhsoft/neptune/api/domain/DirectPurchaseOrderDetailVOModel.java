...
/**
 * DirectPurchaseOrderDetailVO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class DirectPurchaseOrderDetailVOModel extends ApiCloudObject {

    @ApiCloudField(value="明细编号", example="1")
    private Integer detailNum;
    @ApiCloudField(value="商品编码", example="150050001")
    private Integer itemNum;
    @ApiCloudField(value="采购数量（小数点3位）", example="1.0")
    ...
    @ApiCloudField(value="配送基本单价", example="960.0")
    private BigDecimal purchaseOrderDetailTransferPrice;
    @ApiCloudField(value="收货数量", example="5.0")
    private BigDecimal itemBranchReceivedUseQty;
    @ApiCloudField(value="收货基本数量", example="50.0")
    private BigDecimal itemBranchReceivedQty;
}
