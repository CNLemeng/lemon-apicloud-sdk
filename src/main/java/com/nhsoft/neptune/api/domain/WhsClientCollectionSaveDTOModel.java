...
/**
 * WhsClientCollectionSaveDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class WhsClientCollectionSaveDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="收款日期", example="2024-01-01 00:00:00", required=true)
    private String collectionDate;
    @ApiCloudField(value="收款方式", example="现金", required=true)
    ...
    @ApiCloudField(value="收款金额", example="500.0", required=true)
    ...
    @ApiCloudField(value="预收余额", example="0.0", required=true)
